...
module.exports = {
  ...
  computeSummaryEmailContent: function (_meeting, _globalUrl) {
    ...
    // htmlString = htmlString.concat(
    //   '[Unsubscribe from further summary emails of this meeting group](', _unsubUrl, ')');
  ...
  buildAgendaItemString: function (_string, _agendaitems) {
    ...
    for (_agendaitem = 0; _agendaitem < _agendaitems.length; _agendaitem++) {
