...
module.exports = function (grunt) {
  ...
  grunt.config.set('sails-linker', {
    devJs: {
      ...
      files: {
        '.tmp/public/**/*.html': ['.tmp/public/browserify/debug.' + version + '.js', require('../pipeline').jsFilesToInject],
        'views/**/*.html': ['.tmp/public/browserify/debug.' + version + '.js', require('../pipeline').jsFilesToInject],
        'views/**/*.ejs': ['.tmp/public/browserify/debug.' + version + '.js', require('../pipeline').jsFilesToInject]
      }
    },
