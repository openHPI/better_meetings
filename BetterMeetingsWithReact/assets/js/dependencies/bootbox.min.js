...
!function (t, e) {
  ...
  function l(t) {
    ...
    return t = e.extend({}, f, t), t.buttons || (t.buttons = {}), t.backdrop = t.backdrop ? "static" : !1, o = t.buttons, a = r(o), i(o, function (t, n, r) {
      if (e.isFunction(n) && (n = o[t] = {callback: n}), "object" !== e.type(n))throw new Error("button with key " + t + " must be an object");
  ...
  function u(t, e, o, a) {
    var n = {className: "bootbox-" + t, buttons: p.apply(null, e)};
    return d(s(n, a, o), e)
  }

  function p() {
    for (var t = {}, e = 0, o = arguments.length; o > e; e++) {
      var n = arguments[e], r = n.toLowerCase(), i = n.toUpperCase();
      t[r] = {label: a(i)}
    }
    return t
  }
  ...
  m.defineLocale = function (t, e) {
    return e ? (C[t] = {OK: e.OK, CANCEL: e.CANCEL, CONFIRM: e.CONFIRM}, C[t]) : (delete C[t], null)
  }, m.alert = function () {
    var t;
    ...
    t = l(t);
    var a = e(b.dialog), r = a.find(".modal-dialog"), c = a.find(".modal-body"), s = t.buttons, u = "", p = {onEscape: t.onEscape};
    ...
    var f = function () {
      var t = document.body || document.documentElement, e = t.style, a = e.transition !== o || e.WebkitTransition !== o;
      return a
    };
    ...
    }), e(t.container).append(a), a.modal({backdrop: t.backdrop, keyboard: !1, show: !1}), t.show && a.modal("show"), a
