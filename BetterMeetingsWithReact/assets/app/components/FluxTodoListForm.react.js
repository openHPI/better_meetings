                        ...
                        <div className="modal-body">
                            <form>
                                ...
                                <div className="assign-input-container">
                                    <input id="assign-input" type="text" onChange={this._onChange} />
                                    <input id="assignt-autocomplete" type="text" disabled="disabled" />
                                </div>
                            </form>
                        </div>
    ...
    _onChange: function(event) {
        if(event.target.value.length != 0){
            ...
            if(suggestions.length > 0)
                document.getElementById('assignt-autocomplete').value = suggestions[0].name + ' ' + suggestions[0].surname;
            else
                document.getElementById('assignt-autocomplete').value = '';
        }
