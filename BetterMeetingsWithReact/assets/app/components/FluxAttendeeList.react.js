            ...
            <div id="aside">
              <div className="nano">
                <div className="nano-content">
                  ...
                  <button type="button" id="flux-attendeelist-button"
                          className={ (canEdit) ? "btn btn-info btn-labeled fa fa-plus" : "hidden-container" }
                          data-toggle="modal" data-target="#newAttendeeModal">Add Guest
                  </button>
                </div>
              </div>
               </div>
