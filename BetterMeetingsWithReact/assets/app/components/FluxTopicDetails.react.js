    ...
    return (
      <div className="flux-agendaDetails-container panel">
        ...
        <div className="panel-body">
          ...
          <div className="row">
            <div
              className={ (selected.subAgendaItems !== undefined && selected.subAgendaItems !== null) ? "list-group-item col-md-6 col-xs-12" : "hidden" }>
              <h4>Subitems</h4>
              { this.renderSubitemList() }
            </div>
            <div
              className={ (selected.note !== undefined && selected.note !== null) ? "flux-agendaDetails-notes col-md-6 col-xs-12" : "hidden" }>
              <h4>Note</h4>
              {selected.note}
            </div>
          </div>
